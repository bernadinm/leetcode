...
<img alt="" src="./images/tree1.jpg" style="width: 224px; height: 145px;" />
<pre>
...
<img alt="" src="./images/tree2.jpg" style="width: 224px; height: 225px;" />
<pre>
...
1. When the starting node $y$ is not on $\delta(s, t)$, there are two cases:
    ...
    <img alt="" src="./images/tree-diameter.svg">
